...
def TeacherSignUp(request):
    ...
    return render(request,'class/teacher_signup.html',{'user_form':user_form,'teacher_profile_form':teacher_profile_form,'registered':registered,'user_type':user_type})
...
def StudentSignUp(request):
    ...
    return render(request,'class/student_signup.html',{'user_form':user_form,'student_profile_form':student_profile_form,'registered':registered,'user_type':user_type})
...
def StudentUpdateView(request,pk):
    ...
    return render(request,'class/student_update_page.html',{'profile_updated':profile_updated,'form':form})
...
def TeacherUpdateView(request,pk):
    ...
    return render(request,'class/teacher_update_page.html',{'profile_updated':profile_updated,'form':form})
...
def add_marks(request,pk):
    ...
    if request.method == "POST":
        ...
        form = MarksForm()
    return render(request,'class/add_marks.html',{'form':form,'student':student,'marks_given':marks_given})
...
def update_marks(request,pk):
    ...
    return render(request,'class/update_marks.html',{'form':form,'marks_updated':marks_updated})
...
def add_notice(request):
    ...
    if request.method == "POST":
        ...
        notice = NoticeForm()
    return render(request,'class/write_notice.html',{'notice':notice,'notice_sent':notice_sent})
...
def write_message(request,pk):
    ...
    if request.method == "POST":
        ...
        form = MessageForm()
    return render(request,'class/write_message.html',{'form':form,'teacher':teacher,'message_sent':message_sent})

## For the list of all the messages teacher have received.
@login_required
def messages_list(request,pk):
    teacher = get_object_or_404(models.Teacher,pk=pk)
    return render(request,'class/messages_list.html',{'teacher':teacher})

## Student can see all notice given by their teacher.
@login_required
def class_notice(request,pk):
    student = get_object_or_404(models.Student,pk=pk)
    return render(request,'class/class_notice_list.html',{'student':student})
...
def student_marks_list(request,pk):
    ...
    return render(request,'class/student_marks_list.html',{'student':student,'given_marks':given_marks})
...
def student_added(request):
    return render(request,'class/student_added.html',{})
...
def students_list(request):
    ...
    template = "class/students_list.html"
    return render(request, template, context)
...
def teachers_list(request):
    ...
    template = "class/teachers_list.html"
    return render(request, template, context)
...
def upload_assignment(request):
    ...
    if request.method == 'POST':
        ...
        form = AssignmentForm()
    return render(request,'class/upload_assignment.html',{'form':form,'assignment_uploaded':assignment_uploaded})
...
def class_assignment(request):
    ...
    return render(request,'class/class_assignment.html',{'student':student,'assignment_list':assignment_list})

## List of all the assignments uploaded by the teacher himself.
@login_required
def assignment_list(request):
    teacher = request.user.Teacher
    return render(request,'class/assignment_list.html',{'teacher':teacher})
...
def update_assignment(request,id=None):
    ...
    template = "class/update_assignment.html"
    return render(request, template, context)
...
def assignment_delete(request, id=None):
    ...
    template = "class/assignment_delete.html"
    return render(request, template, context)
...
def submit_assignment(request, id=None):
    ...
    if request.method == 'POST':
        ...
        form = SubmitForm()
    return render(request,'class/submit_assignment.html',{'form':form,})

## To see all the submissions done by the students.
@login_required
def submit_list(request):
    teacher = request.user.Teacher
    return render(request,'class/submit_list.html',{'teacher':teacher})
...
def change_password(request):
    if request.method == 'POST':
        ...
        args = {'form':form}
        return render(request,'class/change_password.html',args)
